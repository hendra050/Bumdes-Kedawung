...
$query_harga = "SELECT harga FROM omset_peternakan WHERE output_id = '$id' ";
...
if (mysqli_num_rows($result) > 0) {
    ...
    $update_query = "UPDATE omset_peternakan SET output_tanggal='$tanggal', jumlah='$jual', harga='$harga', output_total='$total' WHERE output_id='$id'";
