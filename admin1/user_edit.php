              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="level" required="required">
                    ...
                    <option <?php if($d['user_level'] == "pertashop"){echo "selected='selected'";} ?> value="pertashop"> Pertashop </option>
                    <option <?php if($d['user_level'] == "peternakan"){echo "selected='selected'";} ?> value="peternakan"> Peternakan </option>
                  </select>
                </div>
